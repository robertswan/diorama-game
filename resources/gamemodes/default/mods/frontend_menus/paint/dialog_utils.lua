local DialogElement = require ("resources/gamemodes/default/mods/frontend_menus/paint/dialog_element")
local IconDrawer = require ("resources/gamemodes/default/mods/frontend_menus/paint/here_we_go")
