...
return function ()
    ...
    instance:addMenuItem (LabelMenuItem ("Servers require a per person password."))
    instance:addMenuItem (LabelMenuItem ("You have to make this up for your player name."))
