...
local CheckboxMenuItem = require ("resources/gamemodes/default/mods/frontend_menus/menu_items/checkbox_menu_item")
local KeySelectMenuItem = require ("resources/gamemodes/default/mods/frontend_menus/menu_items/key_select_menu_item")
local LabelMenuItem = require ("resources/gamemodes/default/mods/frontend_menus/menu_items/label_menu_item")
local NumberMenuItem = require ("resources/gamemodes/default/mods/frontend_menus/menu_items/number_menu_item")
local SliderMenuItem = require ("resources/gamemodes/default/mods/frontend_menus/menu_items/slider_menu_item")
