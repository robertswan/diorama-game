...
local blocks =
{
    ...
    {name = "computer",                 uvs = {3, 0, 3, 0, 2, 0, 3, 0, 3, 0, 3,0 }},
    {name = "grass",                    uvs = {10, 0, 9, 0, 11, 0}},
    {name = "mud",                      uvs = {11, 0}},
    {name = "tree trunk big",           uvs = {1, 1, 2, 1, 2, 1}, tag = "breakable:axe2"},
    {name = "tree trunk small",         uvs = {5, 0, 2, 1, 2, 1}, shape = "pole", tag = "breakable:axe1"},
    {name = "leaves",                   uvs = {7, 0}},

    -- 10    
    {name = "thin grass",               uvs = {8, 0}, shape = "cross",    isSolid = false},
    {name = "concrete",                 uvs = {1, 0}},
    {name = "concrete breakable",       uvs = {9, 3}, tag = "breakable:belt"},
    {name = "vector tile",              uvs = {1, 6}},
    {name = "vector brick",             uvs = {2, 6, 1, 6, 1, 6}},
    {name = "vector breakable brick",   uvs = {3, 6}, tag = "breakable:belt"},
    ...
    {name = "ice breakable",            uvs = {8, 3}, tag = "breakable:belt"},
    {name = "ice tree",                 uvs = {7, 3, 6, 3, 6, 3}},
    {name = "ice trunk thin",           uvs = {5, 3, 6, 3, 6, 3}, shape = "pole", tag = "breakable:axe1"},
    {name = "sand brick",               uvs = {1, 2, 4, 2, 4, 2}},
    {name = "sand breakable brick",     uvs = {5, 2}, tag = "breakable:belt"},
    {name = "sand",                     uvs = {0, 2}},
    ...
    {name = "rot trunk",                uvs = {12, 4}, tag = "breakable:axe2"},
    {name = "rot trunk thin",           uvs = {11, 4, 12, 4, 12, 4}, shape = "pole", tag = "breakable:axe1"},
    ...
    -- 60
    {name = "artifact placeholder",     uvs = {4, 8, 3, 8, 2, 8, 3, 8, 0, 8, 1, 8}},
    {name = "item placeholder",         uvs = {4, 9, 3, 9, 2, 9, 3, 9, 0, 9, 1, 9}},
}
