...
local blocks =
{
    ...
    {name = "metal pillar",             icon = {6, 0},     textures = {neswtb = {6, 0}}, shape = "pole"},
    ...
    {name = "tree trunk small",         icon = {5, 0},     textures = {nesw = {5, 0}, tb = {2, 1}}, shape = "pole", tag = "smallAxe"},
    {name = "leaves",                   icon = {7, 0},     textures = {neswtb = leaves}},

    -- 10    
    {name = "thin grass",               icon = {8, 0},     textures = {neswtb = {8, 0}}, shape = "cross", isSolid = false},
    ...
    {name = "vector pole",              icon = {5, 6},     textures = {nesw = {5, 6}, tb = {1, 6}}, shape = "pole"},
    {name = "vector grass",             icon = {6, 6},     textures = {neswtb = {6, 6}}, shape = "cross", isSolid = false},
    ...
    {name = "ice trunk thin",           icon = {5, 3},     textures = {nesw = {5, 3}, tb = {6, 3}}, shape = "pole", tag = "smallAxe"},
    ...
    {name = "cactus",                   icon = {9, 2},     textures = {neswtb = {9, 2}}, shape = "cross", isSolid = false},
    ...
    {name = "sand pole",                icon = {8, 2},     textures = {nesw = {8, 2}, tb = {0, 2}}, shape = "pole"},
    ...
    {name = "rot vines X",              icon = {4, 4},     textures = {neswtb = {4, 4}},        shape = "cross", isSolid = false},
    ...
    {name = "rot trunk thin",           icon = {11, 4},    textures = {nesw = {11, 4}, tb = {12, 4}}, shape = "pole", tag = "smallAxe"},
    ...
    {name = "nuke pole",                icon = {2, 5},     textures = {neswtb = {2, 5}}, shape = "pole"},
    ...
    {name = "rock pole",                icon = {10, 6},    textures = {nesw = {10, 6}, tb = {1, 0}}, shape = "pole"},
