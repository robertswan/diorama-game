	...
	if self.isVisible then
        ...
        if self.myAccountId then
    		...
    		if xyz then
                ...
                local xCoord = tostring (math.floor (xyz.xyz [1] * 100) / 100)
    			local yCoord = tostring (math.floor (xyz.xyz [2] * 100) / 100)
    			local zCoord = tostring (math.floor (xyz.xyz [3] * 100) / 100)
