...
local IconNumberEntryMenuItem = require ("gamemodes/default/mods/frontend_menus/menu_items/icon_number_menu_item")
...
local NumberEntryMenuItem = require ("gamemodes/default/mods/frontend_menus/menu_items/number_menu_item")
local PasswordTextEntryMenuItem = require ("gamemodes/default/mods/frontend_menus/menu_items/password_text_entry_menu_item")
