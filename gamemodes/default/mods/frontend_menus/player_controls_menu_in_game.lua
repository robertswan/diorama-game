...
local CheckboxMenuItem = require ("gamemodes/default/mods/frontend_menus/menu_items/checkbox_menu_item")
local KeySelectMenuItem = require ("gamemodes/default/mods/frontend_menus/menu_items/key_select_menu_item")
...
local SliderMenuItem = require ("gamemodes/default/mods/frontend_menus/menu_items/slider_menu_item")
