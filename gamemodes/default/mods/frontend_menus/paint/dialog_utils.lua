local DialogElement = require ("gamemodes/default/mods/frontend_menus/paint/dialog_element")
local IconDrawer = require ("gamemodes/default/mods/frontend_menus/paint/here_we_go")
